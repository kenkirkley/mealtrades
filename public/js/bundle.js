...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2Vua2lya2xleTEzMzAiLCJhIjoiY2s0azY0bWJhMGE5aTNuczB0ZnpvajZtcCJ9.lg0WeUNz_EA2VWfcm_XZVQ'; // needs an element with the id of map in html
  ...
  locations.forEach(function (loc) {
    // Create marker
    var el = document.createElement('div'); // marker is in style.css
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // extends map to include location
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(password, passwordConfirm, token) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Password Reset!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Email Sent Successfuly!'); // window.setTimeout(() => {
              //   location.assign('/');
              // }, 1500);
            }
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('password-confirm').value;
    var token = document.querySelector('.btn').id;
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); // programatically recreate multipart form data
